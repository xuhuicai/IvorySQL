...
extern TimestampTz GetOracleStatementStartTimestamp(void);
extern TimestampTz GetOracleStatementStartTimestampInternal(void);
extern void SetOracleStatementStartTimestamp(void);
extern void SetOracleStatementStartTimestampTo(TimestampTz ts);
