...
CREATE FUNCTION sys.ascii(sys.oracharchar)
RETURNS INT
AS 'MODULE_PATHNAME','ora_ascii'
LANGUAGE C
STRICT
...
CREATE FUNCTION sys.ascii(sys.oracharbyte)
RETURNS INT
AS 'MODULE_PATHNAME','ora_ascii'
LANGUAGE C
STRICT
...
CREATE FUNCTION sys.ascii(sys.oravarcharbyte)
RETURNS INT
AS 'MODULE_PATHNAME','ora_ascii'
LANGUAGE C
STRICT
...
CREATE FUNCTION sys.ascii(text)
RETURNS INT
AS 'MODULE_PATHNAME','ora_ascii'
LANGUAGE C
STRICT
